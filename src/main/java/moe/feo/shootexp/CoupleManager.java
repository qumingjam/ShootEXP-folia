...
public class CoupleManager {
    ...
    private static final Map<UUID, Couple> activeCoupleMap = new ConcurrentHashMap<>();// 正在干活的玩家名单
     ...
     * @return 所有活跃情侣的 Map
     */
    public static Map<UUID, Couple> getAllCouples() {
        return activeCoupleMap;
    }
