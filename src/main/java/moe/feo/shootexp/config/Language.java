...
public enum Language {
    ...
    COMMAND_TOGGLE_MESSAGES_ON("command.toggle-messages-on"),
    COMMAND_TOGGLE_MESSAGES_OFF("command.toggle-messages-off"),
    COMMAND_TOGGLE_ATTACK_ON("command.toggle-attack-on"),
    COMMAND_TOGGLE_ATTACK_OFF("command.toggle-attack-off"),
    ...
    COMMAND_HELP_TOGGLE("command.help.toggle"), COMMAND_HELP_GUI("command.help.gui");
    ...
    public String getString() {
        ...
        if (string != null){
            string = LegacyComponentSerializer.legacySection().serialize(
    ...
    public List<String> getStringList() {
        ...
        for (String string : source) {
            list.add(LegacyComponentSerializer.legacySection().serialize(
                LegacyComponentSerializer.legacyAmpersand().deserialize(string)
            ));
        }
        return list;
